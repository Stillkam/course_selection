...
$sql="select SNAME,college from student where SID='{$SID}'";
...
?>
    ...
    <div class="content">
        <div class="alert alert-info" style="border-left-width: 1px;margin-left: 50px;margin-right: 200px;">
                ...
                <strong>SID</strong> cannot been modified.Please be <strong>careful</strong>,your modification will cause <strong>Unpredictable consequences.</strong>
        </div>
        <h2 style="margin-left: 50px;font-style:Comic Sans MS;color:CadetBlue;margin-top: 50px;">Course INFO</h2>
        <div style="margin-left: 50px;margin-top: 50px;">
        <form method="post" action="ad_s_mfr.php">
            <div class="field-box" style="margin-bottom: 25px;">
                <label>SID: &nbsp&nbsp<span class="label label-info">
                    <?php echo $SID;echo '<input type="hidden" name="SID" value="'.$SID.'">'; ?>
                    </span></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>Student Name:&nbsp&nbsp
<?php echo '<input style="width: 500px;" class="span8 inline-input" placeholder="'.$Sname.'" type="text" name="Sname">'; ?></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>college:&nbsp&nbsp
<?php echo '<input style="width: 500px;margin-left: 50px;" class="span8 inline-input" placeholder="'.$college.'" type="text" name="college">'; ?></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
