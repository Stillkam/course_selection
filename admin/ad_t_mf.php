...
$sql="select Tname,college from teacher where TID='{$TID}'";
...
?>
    ...
    <div class="content">
        <div class="alert alert-info" style="border-left-width: 1px;margin-left: 50px;margin-right: 200px;">
                ...
                <strong>TID</strong> cannot been modified.Please be <strong>careful</strong>,your modification will cause <strong>Unpredictable consequences.</strong>
        </div>
        <h2 style="margin-left: 50px;font-style:Comic Sans MS;color:CadetBlue;margin-top: 50px;">Course INFO</h2>
        <div style="margin-left: 50px;margin-top: 50px;">
        <form method="post" action="ad_t_mfr.php">
            <div class="field-box" style="margin-bottom: 25px;">
                <label>TID: &nbsp&nbsp<span class="label label-info">
                    <?php echo $TID;echo '<input type="hidden" name="TID" value="'.$TID.'">'; ?>
                    </span></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
