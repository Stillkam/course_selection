...
esheet" href="http://localhost/WORK/course_selection/css/compiled/calendar.css" type="text/css" media="screen" />
...
$conn = new mysqli('localhost','root' , '941126xiangjie', 'courses');
    ...
    $sql = "insert into teacher values('{$TID}','{$Tname}','{$college}')";
