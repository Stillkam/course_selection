    ...
    <div class="content">
        ...
        <thead>
             <tr>
                          ...
                          <th>Course Time</th>
                          <th>Num</th>
                          <th><a class="btn-flat" href="ad_c_add.php">&nbsp&nbspADD&nbsp&nbsp</a></th>
                          <th></th>
             </tr>
        </thead>
            <tbody>
...
$conn = new mysqli('localhost','root' , '941126xiangjie', 'courses');
    ...
    $sql = "select CID,Cname,Tname,Croom,Credit,Ctime,Cnum from course ";
...
while($row = $result->fetch_assoc()){
        ...
        echo '<td>'.$row['Cnum'].'</td>';
        echo '<td><form method="post" action="ad_c_mf.php">
        <input  name="CID" value="'.$row['CID'].'" type="hidden">
        <input type="submit" value="modify" class="btn-flat white"> </form></td>
        <td><form method="post" action="ad_c_de.php">
        <input  name="CID" value="'.$row['CID'].'" type="hidden">
