    ...
    <div class="content">
        <div class="alert alert-info" style="border-left-width: 1px;margin-left: 50px;margin-right: 200px;">
                <i class="icon-lightbulb"></i>
                 Please ADD New User INFO <strong>Carefully</strong>.
        </div>
        ...
        <form role="form" id="form" method="post">
            <div class="field-box" style="margin-bottom: 25px;">
               <label>ID:&nbsp&nbsp<input style="width: 300px;margin-left: 105px;" class="span8 inline-input" placeholder="" type="text" name="ID"></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>User Type:&nbsp&nbsp<select style="width: 214px;margin-left: 55px;left: 35px;height: 30px;" name="usertp">
                    <option value="student">Student</option>
                    <option value="teacher">Teacher</option>
                    <option value="Admin">Admin</option></select></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>Password:&nbsp&nbsp<input style="width: 300px;margin-left: 58px;" class="span8 inline-input" placeholder="" type="password" id="password1" name="password"></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>Confirm Password:<input style="width: 300px;margin-left: 10px;" class="span8 inline-input" placeholder="" type="password" id="password2"><p style="color:#F00" id="pck"></p>
                </label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <input type="button" value="ADD" class="btn-flat danger" id="add"/> 
            </div>
        </form>
        </div>
        </div>
        ...
        document.getElementById('add').addEventListener('click', function (){
            ...
            if(pw1 != pw2) {
                  document.getElementById("pck").innerHTML="<font color='red'>Passwords don't match. Try again?</font>";
                   ...
                   document.getElementById('form').action="ad_user_addr.php";
