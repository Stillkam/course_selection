    ...
    <div class="content">
        <div class="alert alert-info" style="border-left-width: 1px;margin-left: 50px;margin-right: 200px;">
                <i class="icon-lightbulb"></i>
                 Please ADD New Teacher INFO <strong>Carefully</strong>.
        </div>
        <h2 style="margin-left: 50px;font-style:Comic Sans MS;color:CadetBlue;margin-top: 50px;">Teacher INFO</h2>
        <div style="margin-left: 50px;margin-top: 50px;">
        <form method="post" action="ad_t_addr.php">
            <div class="field-box" style="margin-bottom: 25px;">
               <label>TID:&nbsp&nbsp<input style="width: 500px;margin-left: 85px;" class="span8 inline-input" placeholder="" type="text" name="TID"></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
                <label>Teacher Name:&nbsp&nbsp<input style="width: 500px;margin-left: 15px;" class="span8 inline-input" placeholder="" type="text" name="Tname"></label>
            </div>
            <div class="field-box" style="margin-bottom: 25px;">
