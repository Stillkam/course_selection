        ...
        <table class="fc-header" style="width:100%">
            <tbody>
                ...
                <td class="fc-header-center">
                    ...
                    <h2 style="color:DarkCyan;"> <?php echo $courseID.'&nbsp&nbsp';?> Query Results </h2>
                    </span>
                </td>
                </tr>
            </tbody>
...
<?php
 $conn = new mysqli('localhost','root' , '941126xiangjie', 'courses');
    ...
    $sql = "select CID,Cname,Tname,Croom,Credit,Ctime,Cnum from course where course.CID like '$courseID%'";
